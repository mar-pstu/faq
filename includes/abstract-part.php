...
abstract class Part {
	...
	/**
	 * Получает настройки плагина для этой "части"
	 * */
	protected function get_part_option( $part_name, $default = [] ) {
		return array_merge( apply_filters( "{$this->plugin_name}-default_part_option", $default, $part_name ), get_option( $part_name, [] ) );
	}
